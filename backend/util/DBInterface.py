...
users = Table("users", meta, Column('email', String, primary_key=True),
...
courses = Table("courses", meta, Column('id', String, primary_key=True),
    Column('code', String, nullable=False),
    Column('name', String(50), nullable=False),
    Column('semester', String(4), nullable=False),
)

notes = Table("notes", meta, Column('id', String, primary_key=True),
    Column('course', String, ForeignKey("courses.id"), nullable=False),
    Column('points', Integer, nullable=False),
)

uploads = Table("uploads", meta, Column('uploader', String, ForeignKey("users.email"), primary_key=True),
